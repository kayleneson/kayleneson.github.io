 ...
 */
function setBackgroundColor(color) {const container = document.getElementById("q1-container");
 ...
 */
function redButtonClicked() {setBackgroundColor('#EF476F');
...
function yellowButtonClicked() {
  ...
  // This gets the element with id "q1-btn-yellow" and sets the browser to run the function yellowButtonClicked() when someone clicks the element
...
function greenButtonClicked() {
  ...
  // This gets the element with id "q1-btn-green" and sets the browser to run the function greenButtonClicked() when someone clicks the element
...
// This gets the element with id "q1-btn-light-blue" and sets the browser to run the function lightBlueButtonClicked() when someone clicks the element
...
// This gets the element with id "q1-btn-blue" and sets the browser to run the function blueButtonClicked() when someone clicks the element
